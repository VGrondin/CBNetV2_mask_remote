...
_base_ = [
    "configs/keypoints/cascade_mask_rcnn_cbv2_swinS_3x_coco.py", 	# dual swin backbone
]
...
# load_from = '/media/vince/DataStorageHDD/Models/cascade_mask_rcnn_cbv2_swin_small_patch4_window7_mstrain_400-1400_adamw_3x_coco.pth'
