...
class CocoDataset(CustomDataset):
    ...
    def _parse_ann_info(self, img_info, ann_info):
        ...
        for i, ann in enumerate(ann_info):
            ...
            if "keypoints" in ann:
                keypoints = ann["keypoints"]  # list[int]
                ...
                # pts = keypoints.reshape((1,-1,3))
                pts = keypoints.reshape(5, -1)
                gt_keypoints.append(pts)
                # pts = keypoints.reshape((-1,3))[:,(0,1)]
